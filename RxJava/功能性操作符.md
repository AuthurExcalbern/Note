...
- [线程调度操作符使用详解](./线程调度操作符使用详解.md)
- [线程调度底层原理](./线程调度底层原理.md)
...
![](./img/onExceptionResumeNext结果.webp)
...
- 测试结果
  ...
  - 新的Observable发送Complete 事件 = 原始Observable停止发送 & 不重新发送
    ...
    ![](./img/repeatWhen结果1.webp)

  - 新的Observable发送Error 事件 = 原始Observable停止发送 & 不重新发送

    ![](./img/repeatWhen结果2.webp)

  - 新的Observable发送其余事件 = 原始Observable重新发送

    ![](./img/repeatWhen结果3.webp)

## 项目实例

- [（有条件）网络请求轮询（结合Retrofit）](https://www.jianshu.com/p/dbeaaa4afad5)
- [网络请求出错重连（结合Retrofit）](https://www.jianshu.com/p/508c30aef0c1)