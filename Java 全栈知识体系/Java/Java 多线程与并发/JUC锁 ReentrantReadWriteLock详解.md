...
![img](img/java-thread-x-readwritelock-1.png)
...
![img](img/java-thread-x-readwritelock-2.png)
...
![img](img/java-thread-x-readwritelock-3.png)
...
![img](img/java-thread-x-readwritelock-4.png)
...
![img](img/java-thread-x-readwritelock-5.png)
