...
基于volatile保证单次的读/写操作具有原子性的理解，你将能够理解如下两个问题：
...
![img](img/java-thread-x-key-volatile-1.png)
...
![img](img/java-thread-x-key-volatile-2.png)
...
![img](img/java-thread-x-key-volatile-3.png)

![img](img/java-thread-x-key-volatile-4.png)
