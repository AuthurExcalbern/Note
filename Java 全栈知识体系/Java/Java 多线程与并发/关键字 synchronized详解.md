...
```java
public class Synchronized ObjectLock implements Runnable {
    static SynchronizedObjectLock instence1 = new SynchronizedObjectLock();
    static SynchronizedObjectLock instence2 = new SynchronizedObjectLock();
...
```java
public class Synchronized Demo2 {
...
![img](img/java-thread-x-key-schronized-1.png)
...
![img](img/java-thread-x-key-schronized-2.png)
...
![img](img/java-thread-x-key-schronized-3.png)
...
![img](img/java-thread-x-key-schronized-4.png)
...
![img](img/java-thread-x-key-schronized-5.png)
...
![img](img/java-thread-x-key-schronized-6.png)
...
![img](img/java-thread-x-key-schronized-7.png)
...
![img](img/java-thread-x-key-schronized-8.png)
...
![img](img/java-thread-x-key-schronized-9.png)
...
- https://www.cnblogsss.com/wuchaodzxx/p/6867546.html
