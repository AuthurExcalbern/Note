...
class MainLifecycleObserver(
    ...
    private fun connectService() {
        ...
        MyApplication.context.bindService(currentCityServiceIntent, currentCityServiceConnection,
        ...
        MyApplication.context.bindService(userStateServiceIntent, userStateServiceConnection,
            AppCompatActivity.BIND_AUTO_CREATE
        )
    }
